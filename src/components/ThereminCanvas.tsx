...
export default function ThereminCanvas({
  ...
  return (
    ...
    >
      ...
      {/* Active Web camera activation toggle button — always top-right, always visible (above activation overlay) */}
      <div className="absolute top-[5.5rem] right-4 md:top-28 md:right-12 z-50 pointer-events-auto flex items-center gap-2">
        {cameraError && (
