...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* HUD Float Layer Panels (Left telemetry indicators) */}
      <div className="absolute inset-0 z-20 pointer-events-none flex justify-between items-center px-6 md:px-12">
        
        {/* Left Floating Box: Real-Time Audio Telemetry */}
